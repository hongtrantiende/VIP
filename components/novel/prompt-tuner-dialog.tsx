...
- **Tự động phân tích bối cảnh truyện và chỉ định quy tắc dịch tên nhân vật/địa danh phù hợp nhất**:
  ...
  + Nếu phát hiện bối cảnh Trung Quốc cổ trang/Tiên Hiệp: Bắt buộc yêu cầu AI dịch tên nhân vật sang phiên âm Hán-Việt chuẩn và viết hoa đẹp đẽ (Ví dụ: Tô Dật, Tiêu Viêm).
