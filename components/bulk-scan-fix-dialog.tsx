...
import type { ScanFixOptions, ScanFixResult } from "@/lib/chapter-tools/scan-fix-translate";
import { runScanFix } from "@/lib/chapter-tools/scan-fix-translate";
import { saveBulkResults } from "@/lib/chapter-tools/bulk-translate";
...
export function BulkScanFixDialog({
  open,
  onOpenChange,
  novelId,
  selectedChapterIds,
      ...
      <DialogContent className="sm:max-w-2xl">
        ...
        <DialogHeader>
          <div className="flex items-center justify-between pr-8">
            <div>
              <DialogTitle>
                Quét lỗi & Sửa ({selectedChapterIds.length} chương)
              </DialogTitle>
              <DialogDescription>
                AI tự động đọc, kiểm tra và sửa lỗi logic, xưng hô, tên nhân vật, chính tả.
              </DialogDescription>
            </div>
            {isRunning && (
              <Button
