...
export const TREE_STRUCTURE: TreeNode[] = [
  ...
  },
  {
    ...
    children: [
      { type: "leaf", id: "chapter-translate-prompt", label: "Dịch Thuần AI" },
      { type: "leaf", id: "chapter-translate-hybrid", label: "Dịch STV + AI" },
      { type: "leaf", id: "chapter-translate-edit", label: "Biên Tập AI" },
